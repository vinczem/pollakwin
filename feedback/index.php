        ...
        <div class="container has-text-centered">
            <div class="column is-6 is-offset-3">
                ...
                <p>
                    ...
                    <span>A beküldők között kisorsolunk egy ajándékcsomagot!</span>
                <br>
                </p>
                ...
                <div class="box">
                    ...
                    <form action="../admin/addfeedback.php" method="post" id="kerdoiv">
                        ...
                        <p class="control is-expanded">
                                ...
                                E-mail</label>
                                <input name="email" class="form__field" type="email" id="email" placeholder="Email cím" onkeyup="valtozas();">
                            </p>
                        </div>
